Feature: Password authentication
  ...
  Scenario: password authentication
    Given there is an application with "client id" and "client secret"
    And there is a user "php@soundcloud.com" with password "secret"
    When I do password authentication with "client id", "client secret", "php@soundcloud.com" and "secret"
